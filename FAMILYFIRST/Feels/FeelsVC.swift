...
class FeelsVC : UIViewController {
...
extension FeelsVC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension FeelsVC : UITextFieldDelegate {
